    ...
    <PageLayout>
      <div className=" mb-16 mt-16 container mx-auto px-6 max-w-7xl">
        ...
        <div className="space-y-12">
          ...
          <div className="bg-linear-to-r from-[var(--accent-primary)]/20 to-[var(--accent-secondary)]/20 border-2 border-[var(--accent-primary)]/50 rounded-2xl p-6 text-center">
              ...
              <div className="space-y-4">
                {REGULATIONS_COLUMN_1.map((item, index) => (
                  <a
                    ...
                    className="flex items-start gap-3 bg-[var(--accent-primary)]/5 border border-[var(--accent-primary)]/20 rounded-lg p-4 hover:bg-[var(--accent-primary)]/10 transition-all cursor-pointer"
                  >
          ...
          <section className="grid md:grid-cols-2 gap-6">
            {/* Mapa de Cobertura */}
            <div className="bg-linear-to-br from-[var(--accent-primary)]/10 to-[var(--accent-secondary)]/10 border border-[var(--accent-primary)]/30 rounded-2xl p-8 hover:from-[var(--accent-primary)]/20 hover:to-[var(--accent-secondary)]/20 transition-all cursor-pointer group">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 bg-[var(--accent-primary)]/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  <MapPin className="w-7 h-7 text-[var(--accent-primary)]" />
                </div>
            ...
            {/* Procedimiento PQR's */}
            <div className="bg-linear-to-br from-[var(--accent-secondary)]/10 to-[var(--accent-primary)]/10 border border-[var(--accent-secondary)]/30 rounded-2xl p-8 hover:from-[var(--accent-secondary)]/20 hover:to-[var(--accent-primary)]/20 transition-all cursor-pointer group">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 bg-[var(--accent-secondary)]/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  <HelpCircle className="w-7 h-7 text-[var(--accent-secondary)]" />
                </div>
                <h3 className="text-2xl font-bold text-[var(--accent-secondary)]">
          ...
          <section className="bg-linear-to-br from-[var(--accent-primary)]/10 to-[var(--accent-secondary)]/10 border border-[var(--accent-primary)]/20 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to={ROUTES.CONTACT}
                className="bg-linear-to-r from-[var(--accent-primary)] to-[var(--accent-secondary)] px-8 py-3 rounded-xl font-semibold dark:text-white hover:from-[var(--accent-secondary)] hover:to-[var(--accent-primary)] hover:scale-105 transition-all duration-700 ease-in-out text-center"
              >
                Contactar Soporte
              </Link>
