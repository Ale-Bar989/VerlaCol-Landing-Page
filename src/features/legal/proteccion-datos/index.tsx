        ...
        <div className="space-y-12">
          ...
          <section className="bg-white/5 border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <FileCheck className="w-6 h-6 text-[var(--accent-primary)]" />
              ...
              {DATA_PRINCIPLES.map((principle, index) => (
                ...
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-[var(--accent-primary)]/10 rounded-lg mb-4">
                    <principle.icon className="w-6 h-6 text-[var(--accent-primary)]" />
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  ...
                  className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all"
                >
                  <div className={`inline-flex items-center justify-center w-12 h-12 bg-${item.color}/10 rounded-lg mb-4`}>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={index}
                  className="flex items-start gap-3 bg-[var(--accent-primary)]/5 border border-[var(--accent-primary)]/20 rounded-lg p-4"
                >
                  <div className="w-6 h-6 bg-[var(--accent-primary)]/20 rounded-full flex items-center justify-center shrink-0 mt-0.5">
          ...
          <section className="bg-white/5 border border-white/10 rounded-2xl p-8">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                <Lock className="w-5 h-5 text-[var(--accent-primary)] mt-1 shrink-0" />
