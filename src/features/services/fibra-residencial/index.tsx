      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-1/2 left-1/4 w-[600px] h-[600px] rounded-full -translate-x-1/2 -translate-y-1/2 blur-[80px] bg-[radial-gradient(circle_at_center,var(--accent-primary),transparent_70%)]" />
            <div className="absolute top-1/3 right-1/4 w-[400px] h-[400px] rounded-full translate-x-1/2 -translate-y-1/2 blur-[60px] bg-[radial-gradient(circle_at_center,var(--accent-secondary),transparent_70%)]" />
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  Experimenta la revolución de la fibra óptica FTTH con
                  velocidades ultrarrápidas y conexión simétrica. Nuestra
                  tecnología directa a tu hogar elimina intermediarios,
                  ofreciendo la mejor experiencia de navegación, streaming en 4K
                  y gaming sin latencia.
                </p>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(https://images.unsplash.com/photo-1581092160562-40aa08e78837?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80)",
                }}
              />
              <div
