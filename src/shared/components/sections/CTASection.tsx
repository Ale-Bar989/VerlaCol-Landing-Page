      ...
      <div className="w-full max-w-5xl relative z-10">
        ...
        >
          ...
          <div className="relative z-10 text-center">
            <h2 className={`text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent mx-auto ${isDark ? 'bg-gradient-to-r from-white to-blue-100' : 'bg-gradient-to-r from-gray-900 to-blue-900'}`}>
              {title}
            </h2>
