  ...
  ({
    ...
    return (
      ...
      >
        ...
        {/* Código de error gigante - Responsive */}
        <div className="relative z-10 text-center w-full -mb-[0.8em] sm:-mb-[2em] md:-mb-[6em] lg:-mb-[10em] xl:-mb-[13em] 2xl:-mb-[15em]">
          <div className="relative inline-block">
            <h1 className="notfound-404-text animate-float">{errorCode}</h1>
            {/* Sombra del código */}
            <div
              className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full -z-10 blur-2xl opacity-30 bg-linear-to-br ${config.gradientFrom} ${config.gradientTo}`}
            />
          </div>
        </div>
        ...
        <div className="relative z-10 text-center px-6 max-w-2xl mx-4">
          <div className="notfound-card glassmorphism-card border border-white/10 max-w-2xl mx-auto">
            ...
            <div className="flex justify-center mb-6">
              <div
                className={`p-4 rounded-full bg-white/10 backdrop-blur-sm ${config.iconColor}`}
              >
